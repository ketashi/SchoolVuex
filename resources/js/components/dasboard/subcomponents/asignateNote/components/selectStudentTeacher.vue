...
export default {
    ...
    computed: {
       ...mapState('asignateN', ['student']),
        getStudent() {
            const data = this.students.map(student => {
                return student.lastName
            });
            this.dataStudent = data;
            this.getSelectStudentTeacher(this.students)

        },
    },
    methods: {
        ...mapMutations('asignateN', ['getDataStudentTeacher','getSelectStudentTeacher']),
    },
    created() {
        this.getDataStudentTeacher()
    },
}
</script>
<style>
