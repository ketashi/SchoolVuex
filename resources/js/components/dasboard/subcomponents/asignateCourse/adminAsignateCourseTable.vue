    ...
    <div>
        <v-container>
            <v-card>
                ...
                <v-data-table
                    :headers="asignateCourse.headers"
                    :items="items"
                    :search="search"
                >
...
export default {
    ...
    ...mapMutations('asignateC',['getDataAsignateCourse','getEdit'])
    },
    computed: {
        ...mapState('asignateC', ['asignateCourse', 'items'])
        
    },
    created() {
        this.getDataAsignateCourse()
    },
};
</script>
