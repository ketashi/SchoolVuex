...
export default {
    ...
    computed: {
       ...mapState('asignateC', ['student']),
        getStudent() {
            const data = this.students.map(student => {
                return student.lastName
            });
            this.dataStudent = data;
            this.getSelectStudent(this.students)
            this.getSelectApoderadoStudent(this.students)
        },
    },
    methods: {
        ...mapMutations('asignateC', ['getDataStudent','getSelectStudent']),
        ...mapMutations('asignateA', ['getSelectApoderadoStudent'])
    },
    created() {
        this.getDataStudent()
    },
